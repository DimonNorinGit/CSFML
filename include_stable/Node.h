...
namespace csf {
	...
	////////////////////////////////////////////////////////////
	class Node : public sf::Transformable , public Object
	{
	public:
		...
		void setZetIndex(int index);

		int getZetIndex()const;
		...
		////////////////////////////////////////////////////////////
		bool delegateEvent(sf::Event event , positionEvent pos_event);		
	...
	protected:
		...
		////////////////////////////////////////////////////////////
		//maybe virtual
		virtual void draw(sf::RenderTarget& target, sf::RenderStates parentStates) const;

		//for anchor layout as well
		virtual void updateChildrenParams();
	...
	private:
		...
		void updateZetIndex(Node* child);
		std::list<Node*> m_children; //< Node childrens in hierarchy
